...
export function updateImageDisplay(input) { 
  ...
  //      writeAudit();
          ...
          if (imageType == "RAF") { functionFullSizeRAF(); } else if (imageType == "HIF") { resolve(functionFullSizeHIF()); } else { resolve(functionFullSizeJPG()); }
         //  resolve(auditArray[0]);
        };
    })(img);
